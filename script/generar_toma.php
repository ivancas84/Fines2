...
';
    ...
    if(!$enviar_email){
        ...
        try {
            ...
            $mail->Body = "<p>Hola {$toma->docente_->getNombre()}, usted ha recibido este email porque ha tomado posesión en la asignatura <strong>{$toma->curso_->disposicion_->asignatura_->getLabel()}</strong> de sede {$toma->curso_->comision_->sede_->nombre}</p>
<p>Se recuerda que usted asumió el compromiso de:</p>
  <ul>
    <li>Completar las planillas de finalización en tiempo y forma: <strong>FECHA LIMITE DE ENTREGA DE NOTAS 20/7/2026</strong></li>
    ...
    <li>Utilizar la última semana de recuperación o intensificación de la enseñanza, 13/07/2026 a 17/07/2026: El objetivo es que el alumno aprenda los contenidos mínimos</li>
