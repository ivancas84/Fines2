...
add_submenu_page(
    null, 
    'Procesar Alumnos Comisión',
    'Procesar Alumnos Comisión', 
    'edit_posts', 
    'fines-plugin-cac2-p', 
    'cac2_p_cargar_alumnos_comision_page'
);

function cac2_p_cargar_alumnos_comision_page() {
    wp_page_message();
    ...
    /** @var Comision_ */ $comision = $dataProvider->fetchEntityByParams("comision", ["id" => $_POST['comision_id']]);
