    ...
    <tbody>
        <?php foreach ($personas as $persona): ?>
            ...
            <tr>
                ...
                <td>
                    <a href="<?= esc_url(admin_url('admin.php?page=fines-plugin-ap3&persona_id=' . $persona->id)); ?>" class="button">Alumno</a>
                    <a href="<?= esc_url(admin_url('admin.php?page=fines-plugin-ad2&persona_id=' . $persona->id)); ?>" class="button">Docente</a>
                </td>
            </tr>
        <?php endforeach; ?>
    </tbody>
