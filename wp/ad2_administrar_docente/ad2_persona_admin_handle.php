...
add_action('admin_post_ad2_persona_admin', 'ad2_persona_admin_handle');

function ad2_persona_admin_handle() {
    $persona_id = wp_initialize_handle("fines-plugin-ad2", "ad2_persona_admin", "persona_id");
