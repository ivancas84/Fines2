...
<p>Constancia de Alumno Regular: <a href="<?=admin_url('admin.php?page='.FINES_PLUGIN.'-car3&persona_id=' . $persona->id)?>" target="_blank">GENERAR</a></p>
<p>Constancia de Pase: <a href="<?=admin_url('admin.php?page='.FINES_PLUGIN.'-cp3&persona_id=' . $persona->id)?>" target="_blank">GENERAR</a></p>
