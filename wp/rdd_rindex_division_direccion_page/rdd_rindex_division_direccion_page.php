...
function rdd_rindex_division_direccion_page() {
    ...
    $output = '<div style="overflow-x: auto; display: block; white-space: nowrap;">';
    $output .= '<table border="1" cellpadding="5" cellspacing="0"  style="width: auto; min-width: 100%; border-collapse: collapse;">';
    $output .= '<thead><tr>';
