<?php use \Fines2\CalificacionDAO; ?>
<?php use \SqlOrganize\Utils\ValueTypesUtils; ?>
...
?>
            <? $detalle_comision_url = admin_url('admin.php?page=fines-plugin-ac2&comision_id=' . $curso->comision); ?>
            <? $administrar_tomas_url = admin_url('admin.php?page=fines-plugin-administrar-toma-comision&comision_id=' . $curso->comision); ?>
            <? $cargar_planilla_calificacion_url = admin_url('admin.php?page=fines-plugin-ppc3&curso_id=' . $curso->id); ?>
            <? $cargar_alumnos_url = admin_url('admin.php?page=fines-plugin-cac&comision_id=' . $curso->comision); ?>
            <? $administrar_persona_url = admin_url('admin.php?page=fines-plugin-ap3&persona_id=' . $curso->toma_activa_?->docente_?->id); ?>
            <? $lista_alumnos_curso_url = admin_url('admin.php?page=fines-plugin-lacu&curso_id=' . $curso->id); ?>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="<?= esc_url(admin_url('admin.php?page=fines-plugin-rdc&comision_id=' . $curso->comision))?>" class="button" title="Rindex Comisión">
                    ...
                    <a href="<?= esc_url(admin_url('admin.php?page=fines-plugin-lacu&curso_id=' . $curso->id))?>" class="button" title="Calificaciones por curso">
