...
function analizarDirectorio($ruta) {
    ...
    echo "📄 Tiene DNI ( " .  $alumno["tiene_dni"] . " ) \n";
    echo "📄 Tiene Certificado ( " .  $alumno["tiene_certificado"] . " ) \n";
    echo "📄 Tiene Constancia ( " .  $alumno["tiene_constancia"] . " ) \n";
    echo "📄 Tiene Partida ( " .  $alumno["tiene_partida"] . " ) \n";
    echo "📄 Previas Completas ( " .  $alumno["previas_completas"] . " ) \n";
    echo "📄 Confirmado dirección ( " .  $alumno["confirmado_direccion"] . " ) \n";
