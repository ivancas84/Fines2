...
$rutaBase = "/home/planfi10/domains/planfines2.com.ar/public_html/upload2";
$rutaUploadPedidos = "/home/planfi10/domains/planfines2.com.ar/public_html/wp/wp-content/uploads";
$db_host_pedidos = 'localhost';        // e.g., 'localhost'
$db_name_pedidos = 'planfi10_wp211';    // Name of the external database
$db_user_pedidos = 'planfi10_wp211';    // Database username
$db_pass_pedidos = 'nF7jJfUcCMDuWaG8azeG';    // Database password
*/
define("RUTA_BASE", "/home/planfi10/domains/planfines2.com.ar/public_html/upload2");


define("DB_HOST_FINES", "localhost");
define("DB_NAME_FINES", "planfi10_20204");
define("DB_USER_FINES", "planfi10_2020");
define("DB_PASS_FINES", "AkDNaVQc8YeGX8ZkUWen");

define("DB_HOST_PEDIDOS", "localhost");
define("DB_NAME_PEDIDOS", "planfi10_wp211");
define("DB_USER_PEDIDOS", "planfi10_wp211");
define("DB_PASS_PEDIDOS", "nF7jJfUcCMDuWaG8azeG");
...
define("PF_USER", "31073351");
define("PF_PASSWORD", "Hola1024");

define("CALENDARIO_ID", "202502110007");
define("PLANILLA_DOCENTE_ID", "202504071000");
