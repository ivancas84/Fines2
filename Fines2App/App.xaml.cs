...
using Fines2App.Activation;
using Fines2App.Contracts.Activation;
using Fines2App.Contracts.Services;
using Fines2App.Contracts.Views;
using Fines2App.Core.Contracts.Services;
using Fines2App.Core.Services;
using Fines2App.Models;
using Fines2App.Services;
using Fines2App.Views;
