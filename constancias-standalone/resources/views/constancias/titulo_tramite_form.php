...
<div class="page-header">
    <div>
        <h1>Constancia de título en trámite</h1>
...
<section class="panel">
    <form class="js-prevent-double-submit" method="post" action="<?= e(url('/constancias/titulo-tramite')) ?>">
        <?= $csrf->field() ?>
        <div class="form-grid">
            ...
            <label class="form-label">Año <input class="form-control" name="anio" value="<?= e($defaults['anio'] ?? '') ?>" required></label>
            <label class="form-label">Modalidad <input class="form-control" name="modalidad" value="<?= e($defaults['modalidad'] ?? '') ?>" required></label>
            <label class="form-label">Orientación <input class="form-control" name="orientacion" value="<?= e($defaults['orientacion'] ?? '') ?>" required></label>
            <label class="form-label">Resolución <input class="form-control" name="resolucion" value="<?= e($defaults['resolucion'] ?? '') ?>" required></label>
