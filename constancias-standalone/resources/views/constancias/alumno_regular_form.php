...
<section class="panel">
    <form class="js-prevent-double-submit" method="post" action="<?= e(url('/constancias/alumno-regular')) ?>">
        <?= $csrf->field() ?>
        <div class="form-grid">
            ...
            <label class="form-label">Año en curso <input class="form-control" name="anio" value="<?= e($defaults['anio'] ?? '') ?>" required></label>
