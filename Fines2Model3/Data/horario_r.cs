...
namespace Fines2Model3.Data
{
    public class Data_horario_r : Data_horario
    {
        ...
        public Data_horario_r (Db db, bool init = true) : base(db, init)
        {
        }

        public Data_horario_r (Db db, bool init = true, params string[] fieldIds) : this(db, init)
        {
            Init(fieldIds);
        }
        ...
        protected void Init(params string[] fieldIds)
        {
            ...
            foreach(string fieldId in fieldIds)
            {
                switch(fieldId)
                {
                    ...
                    case "dia":
                        val = db!.Values("dia");
                        dia__id = (string?)val.GetDefault("id");
                    break;
                }
            }
        }
        ...
        public string? dia__Label { get; set; }

        protected string? _dia__id = null;

        [JsonProperty("dia-id")]
        public string? dia__id
        {
            get { return _dia__id; }
            set { _dia__id = value; dia = value; NotifyPropertyChanged(nameof(dia__id)); }
        }
        protected short? _dia__numero = null;

        [JsonProperty("dia-numero")]
        public short? dia__numero
        {
            get { return _dia__numero; }
            set { _dia__numero = value; NotifyPropertyChanged(nameof(dia__numero)); }
        }
        protected string? _dia__dia = null;

        [JsonProperty("dia-dia")]
        public string? dia__dia
        {
            get { return _dia__dia; }
            set { _dia__dia = value; NotifyPropertyChanged(nameof(dia__dia)); }
        }
    }
}
