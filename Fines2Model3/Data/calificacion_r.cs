...
namespace SqlOrganize.Sql.Fines2Model3
{
    public class Data_calificacion_r : Data_calificacion
    {
        ...
        [JsonProperty("domicilio_per-Label")]
        ...
        [JsonProperty("asignatura_dis-Label")]
        ...
        [JsonProperty("planificacion_dis-Label")]
