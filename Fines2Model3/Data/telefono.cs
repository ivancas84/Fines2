    ...
    public partial class Telefono : Entity
    {
        ...
        public string? prefijo
        {
            ...
            set {
                if( _prefijo != value)
                {
                    _prefijo = value; NotifyPropertyChanged(nameof(prefijo));
                }
            }
        }
        #endregion
        ...
        public static IEnumerable<Telefono> QueryDapper(IDbConnection connection, string sql, object? parameters = null)
        {
            return connection.Query<Telefono, Persona, Domicilio, Telefono>(
                sql,
