...
{
    public class Data_wpwt_psmsc_priorities : SqlOrganize.Data
    {
        ...
        public Data_wpwt_psmsc_priorities(DataInitMode mode = DataInitMode.Default)
        {
            Initialize(mode);
        }
        ...
        protected virtual void Initialize(DataInitMode mode = DataInitMode.Default)
        {
            switch(mode)
            {
                ...
                case DataInitMode.DefaultMain:
                    _id = (long?)ContainerApp.db.Values("wpwt_psmsc_priorities").Default("id").Get("id");
                    _load_order = (int?)ContainerApp.db.Values("wpwt_psmsc_priorities").Default("load_order").Get("load_order");
                break;
            }
        }
