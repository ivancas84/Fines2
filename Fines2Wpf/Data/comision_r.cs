...
namespace Fines2Wpf.Data
{
    public class Data_comision_r : Data_comision
    {
        ...
        public Data_comision_r (DataInitMode mode) : base(mode)
        {
            Initialize(mode);
        }
        ...
        public string? modalidad__id
        {
            ...
            set { _modalidad__id = value; _modalidad = value; NotifyPropertyChanged(); }
        }
        ...
        public string? calendario__id
        {
            ...
            set { _calendario__id = value; _calendario = value; NotifyPropertyChanged(); }
        }
