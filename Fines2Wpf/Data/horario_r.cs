...
namespace Fines2Wpf.Data
{
    public class Data_horario_r : Data_horario
    {
        ...
        public Data_horario_r (DataInitMode mode) : base(mode)
        {
            Initialize(mode);
        }
        ...
        protected override void Initialize(DataInitMode mode = DataInitMode.Null)
        {
            ...
            switch(mode)
            {
                case DataInitMode.Default:
                    ...
                    dia__id = (string?)ContainerApp.db.Values("dia").Default("id").Get("id");
                break;
            }
        }
        ...
        {
            get { return _dia__id; }
            set { _dia__id = value; _dia = value; NotifyPropertyChanged(); }
        }
