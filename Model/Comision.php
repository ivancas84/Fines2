...
class Comision extends Entity
{
    ...
    /** @var \Fines2\Calendario_|null (fk comision.calendario _m:o calendario.id) */
    public ?\Fines2\Calendario_ $calendario_ = null;

    /** @var \Fines2\Comision_|null (fk comision.comision_siguiente _m:o comision.id) */
    public ?\Fines2\Comision_ $comision_siguiente_ = null;

    /** @var \Fines2\Modalidad_|null (fk comision.modalidad _m:o modalidad.id) */
    public ?\Fines2\Modalidad_ $modalidad_ = null;

    /** @var \Fines2\Planificacion_|null (fk comision.planificacion _m:o planificacion.id) */
    public ?\Fines2\Planificacion_ $planificacion_ = null;

    /** @var \Fines2\Sede_|null (fk comision.sede _m:o sede.id) */
    public ?\Fines2\Sede_ $sede_ = null;

    /** @var int|null */
    public ?int $AlumnoComision_Count = null;

    /** @var \Fines2\AlumnoComision_[] (ref alumno_comision.comision _m:o comision.id) */
    public array $AlumnoComision_ = [];

    /** @var int|null */
    public ?int $Comision_comision_siguiente_Count = null;

    /** @var \Fines2\Comision_[] (ref comision.comision_siguiente _m:o comision.id) */
    public array $Comision_comision_siguiente_ = [];

    /** @var int|null */
    public ?int $ComisionRelacionada_Count = null;

    /** @var \Fines2\ComisionRelacionada[] (ref comision_relacionada.comision _m:o comision.id) */
    public array $ComisionRelacionada_ = [];

    /** @var int|null */
    public ?int $ComisionRelacionada_relacion_Count = null;

    /** @var \Fines2\ComisionRelacionada[] (ref comision_relacionada.relacion _m:o comision.id) */
    public array $ComisionRelacionada_relacion_ = [];

    /** @var int|null */
    public ?int $Curso_Count = null;

    /** @var \Fines2\Curso_[] (ref curso.comision _m:o comision.id) */
    public array $Curso_ = [];
