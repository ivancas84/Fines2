    ...
    <form method="post" action="<?= e(url('/establecimiento')) ?>" enctype="multipart/form-data">
        ...
        <div class="table-responsive mt-3">
            <table class="table app-table">
                ...
                <tr>
                    <th>Logo actual</th>
                    <td><?= e($v($establecimiento, 'logo_path') ?: 'Sin imagen') ?></td>
                </tr>
                <tr>
                    <th>Firma actual</th>
                    <td><?= e($v($establecimiento, 'firma_director_path') ?: 'Sin imagen') ?></td>
                </tr>
                <tr>
                    <th>Sello actual</th>
                    <td><?= e($v($establecimiento, 'sello_oval_path') ?: 'Sin imagen') ?></td>
                </tr>
                </tbody>
            </table>
        </div>
