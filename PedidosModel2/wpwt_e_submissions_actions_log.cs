...
{
    public class Data_wpwt_e_submissions_actions_log : SqlOrganize.Sql.Data
    {
        ...
        public Data_wpwt_e_submissions_actions_log(Db db)
        {
            this.db = db;
        }
        ...
        {
            EntityValues val = db!.Values("wpwt_e_submissions_actions_log");
