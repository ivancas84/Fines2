...
{
    public class WpwtPsmscStatuses : SqlOrganize.Sql.EntityData
    {

        public override string entityName => "wpwt_psmsc_statuses";

        public override void Default()
        {
            EntityVal val = db!.Values("wpwt_psmsc_statuses");
