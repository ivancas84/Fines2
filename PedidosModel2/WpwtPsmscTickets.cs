...
{
    public class WpwtPsmscTickets : SqlOrganize.Sql.EntityData
    {

        public override string entityName => "wpwt_psmsc_tickets";

        public override void Default()
        {
            EntityVal val = db!.Values("wpwt_psmsc_tickets");
