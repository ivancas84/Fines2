...
{
    public class WpwtPsmscOptions : SqlOrganize.Sql.EntityData
    {

        public override string entityName => "wpwt_psmsc_options";

        public override void Default()
        {
            EntityVal val = db!.Values("wpwt_psmsc_options");
