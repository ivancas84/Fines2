...
{
    public class Data_wpwt_frmt_form_reports : SqlOrganize.Sql.Data
    {
        ...
        public Data_wpwt_frmt_form_reports(Db db)
        {
            this.db = db;
        }
        ...
        {
            EntityValues val = db!.Values("wpwt_frmt_form_reports");
